...
module.exports = () => {
  ...
  return [
    ...
    { name: '맛집_집_카페_주황', record: { ...food, id: 'sample-food-h1', design: 'house', houseColor: 'orange' } },
    { name: '맛집_집_카페_초록', record: { ...food, id: 'sample-food-h5', design: 'house', houseColor: 'green', place: '초록상회 국수', type: 'meal',
      menus: [{ name: '들기름 막국수', stars: 5 }, { name: '수육 한 접시', stars: 4 }], total: 23000, memo: '들기름 향이 진하다. 다음엔 비빔으로.' } },
    { name: '맛집_집_카페_빨강', record: { ...food, id: 'sample-food-h6', design: 'house', houseColor: 'red', place: '골목 분식', type: 'meal',
      menus: [{ name: '즉석 떡볶이', stars: 5 }, { name: '튀김 모둠', stars: 4 }], total: 14000, memo: '' } },
    ...
    { name: '맛집_집_디저트_최소', record: { ...food, id: 'sample-food-h3', design: 'house', houseColor: 'pink', type: 'dessert', place: '', area: '', withWhom: '', menus: [], total: 0, revisit: 'no', memo: '' } },
    { name: '맛집_집_술집', record: { ...food, id: 'sample-food-h4', design: 'house', houseColor: 'blue', type: 'bar', place: '연남 작은 술집 이름이 꽤 긴 가게', revisit: 'yes' } },
